  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div
        ...
        v-for="user in tradeList.userAddressList"
        :key="user.id"
      >
        <span
          :class="{ username: true, selected: selectedId === user.id }"
    ...
    <div class="trade">
      ...
      <div class="receiveInfo">
        ...
        收货人:<span>{{ consignee }}</span> 手机:<span>{{ consigneeTel }}</span>
      </div>
    </div>
...
export default {
  ...
  async mounted() {
    const resTradeList = await reqGetTrade()
    this.tradeList = resTradeList
    // 默认收件人对应为默认地址的人
    this.selectedId = resTradeList.userAddressList.find(
  ...
  computed: {
    ...
    deliveryAddress() {
      ...
      return userAddressList
        ? userAddressList.find((userAddress) => userAddress.id === selectedId)
            .userAddress
        : {}
    },
    // 收货人
